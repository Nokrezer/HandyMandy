...
export function ProductsBlock({ userInfo, isUserPage }) {
    ...
    return (React.createElement("div", { className: "products" },
        ...
        products.map(product => React.createElement(ProductCard, { key: product.product_id, product: product, fileToken: fileToken, isUserPage: isUserPage, setProducts: setProducts }))));
}
