...
(function (global, factory) {
  ...
  __export(sourcemap_codec_exports, {
    ...
    decodeGeneratedRanges: function decodeGeneratedRanges() {
      return _decodeGeneratedRanges;
    },
    decodeOriginalScopes: function decodeOriginalScopes() {
      return _decodeOriginalScopes;
    },
    encode: function encode() {
      return _encode;
    },
    encodeGeneratedRanges: function encodeGeneratedRanges() {
      return _encodeGeneratedRanges2;
    },
    encodeOriginalScopes: function encodeOriginalScopes() {
      return _encodeOriginalScopes2;
    }
  });
  ...
  // src/scopes.ts
  var EMPTY = [];
  function _decodeOriginalScopes(input) {
  ...
  function _encodeOriginalScopes2(scopes) {
  ...
  function _decodeGeneratedRanges(input) {
    var length = input.length;
    var reader = new StringReader(input);
    var ranges = [];
    var stack = [];
  ...
  function _encodeGeneratedRanges2(ranges) {
