...
function generate() {
  ...
  // Node testers
  iterateProps(definitions, function (typeDefinition) {
    stdout.write("\n      export const is".concat(typeDefinition.name, ": ((n: Node) => boolean) =\n        isTypeOf(\"").concat(typeDefinition.name, "\");\n    "));
  });
  ...
  unionTypes.forEach(function (unionType) {
    stdout.write("\n      export const is".concat(unionType, " = (node: Node): boolean => ") + mapProps(definitions).filter(function (d) {
  ...
  // Node assertion
  iterateProps(definitions, function (typeDefinition) {
    stdout.write("\n      export const assert".concat(typeDefinition.name, ": ((n: Node) => void) =\n        assertTypeOf(\"").concat(typeDefinition.name, "\");\n    "));
  });
